...
const Header = () => {
  return (
    <header className="h-12  z-50 w-full border-b border-border/40 dark:border-zinc-700/40 bg-background/95 dark:bg-zinc-900/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 dark:supports-[backdrop-filter]:bg-zinc-900/60">
